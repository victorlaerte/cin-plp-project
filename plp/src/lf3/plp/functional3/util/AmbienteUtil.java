...
public class AmbienteUtil {
	...
	public static void includeValueBindings(AmbienteExecucao ambiente, Map<Id, Valor> mapIdValor)
	...
	public static Map<Id, Valor> resolveParametersBindings(AmbienteExecucao ambiente, DecPadrao decPadrao,
			List<Expressao> argumentosAplicacao) throws VariavelNaoDeclaradaException, VariavelJaDeclaradaException {
	...
	private static void mapIdAmbiente(AmbienteExecucao ambiente, Map<Id, Valor> mapIdValor, Id id,
			Expressao argumento) {
	...
	private static void mapExpConsAmbiente(AmbienteExecucao ambiente, Map<Id, Valor> mapIdValor, ExpCons expCons,
			Expressao argumento) {
	...
	public static AmbienteExecucao getMainThreadContext(AmbienteExecucao amb) {
